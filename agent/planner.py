...
Goal: "research machine learning and save to notepad"
Steps:
  1. web_search | query: "machine learning overview definition applications"
  2. web_search | query: "machine learning algorithms and future trends"
  3. file_controller | action: write, path: desktop, name: machine_learning.txt, content: "MACHINE LEARNING RESEARCH\\n\\nThis file will be populated with web research results."
...
Goal: "Send a WhatsApp message to John saying meeting tomorrow"
Steps:
  1. send_message | receiver: John, message_text: "Meeting tomorrow", platform: WhatsApp
